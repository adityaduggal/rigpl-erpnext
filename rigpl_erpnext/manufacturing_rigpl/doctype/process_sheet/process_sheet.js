    ...
    refresh: function(frm) {
        ...
        if (frm.doc.status === "In Progress") {
            me.frm.add_custom_button(__("Stop"), function() {
                frappe.call({
                    method: "rigpl_erpnext.manufacturing_rigpl.utils.process_sheet_utils.stop_process_sheet",
                    args: {
        ...
        if (frm.doc.status === "Stopped") {
            frm.add_custom_button(__("UnStop"), function() {
                frappe.call({
                    method: "rigpl_erpnext.manufacturing_rigpl.utils.process_sheet_utils.unstop_process_sheet",
                    args: {
                        "ps_name": frm.doc.name
                    },
                    callback: function(r) {
                    ...
                    fields: [
                        {
                            ...
                            get_query: function() {
                               ...
                               return {
                                    query: "rigpl_erpnext.manufacturing_rigpl.utils.process_sheet_utils.get_bom_template_from_item_name",
                                    filters: filters
                               };
                            },
                        },
...
frappe.ui.form.on("BOM Operation", {
    create_new_job_card: function(frm, dt, dn) {
        ...
        if (child.planned_qty > child.completed_qty && child.status !== "Short Closed" &&
            ...
            frappe.call({
                method: "rigpl_erpnext.manufacturing_rigpl.utils.job_card_utils.make_jc_from_pro_sheet_row",
                args: {
    ...
    stop_operation: function(frm, dt, dn) {
        ...
        if (child.planned_qty > child.completed_qty && (child.status === "Pending" || child.status === "In Progress")) {
            frappe.call({
                method: "rigpl_erpnext.manufacturing_rigpl.utils.process_sheet_utils.stop_ps_operation",
                args: {
                    "op_id": child.name,
                    "psd": frm.doc
                },
