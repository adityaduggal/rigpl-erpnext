...
def on_update(doc, method):
    ...
    if check_conversion:
        frappe.throw(("Editing of Lead {0} NOT ALLOWED since its linked to Customer {1}. Kindly add information "
                      "to Customer Master and not Lead").format(doc.name, check_conversion[0][0]))
