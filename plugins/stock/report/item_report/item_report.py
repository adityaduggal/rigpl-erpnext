...
def get_items(filters):
	...
	data= webnotes.conn.sql("""SELECT t.name, IFNULL(t.brand,"-"), IFNULL(t.tool_type,"-"),
...
def get_conditions(filters):
	...
	if f is None:
		if b is None or c is None or d is None or e is None:
			webnotes.msgprint("Please select ALL of Material, Quality, Tool Type, Is RM", raise_exception=1)
